...
class DataMaster(object):
    def __init__(self):
        ...
        self.data_centrality = np.load('./data/protein_centrality.npy')
        ...
        self.data_centrality = self.data_centrality[:int(train_eval_rate * len(self.data_centrality))]
        ...
        self.test_C = self.data_centrality[int(train_eval_rate * len(self.data_centrality)):]
    ...
    def shuffle(self):
        ...
        self.train_C = np.concatenate([self.data_centrality[self.pos_idx], self.data_centrality[self.neg_idx][mark]])
